...
async function saveOffer(){
 ...
 const body={...{},p_id:Number(id),p_name_ar:$('offerNameAr').value.trim(),p_name_en:$('offerNameEn').value.trim(),p_description_ar:$('offerDescAr').value.trim(),p_description_en:$('offerDescEn').value.trim(),p_price:Number($('offerPrice').value)||0,p_active:$('offerActive').checked,p_category:$('offerCategory').value,p_sort_order:Number($('offerSort').value)||0,p_booking_enabled:$('offerBookingEnabled').checked};
